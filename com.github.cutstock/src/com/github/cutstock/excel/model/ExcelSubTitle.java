 ...
 * @date Jan 7, 2013
 */
public class ExcelSubTitle extends ExcelTitle {

	public ExcelSubTitle(IExcelRectangle rect) {
		this(ResourceUtil.INSTANCE.getNodeValueByName("profile_sub_title"),rect);
	}

	public ExcelSubTitle(String titleName, IExcelRectangle rect) {
