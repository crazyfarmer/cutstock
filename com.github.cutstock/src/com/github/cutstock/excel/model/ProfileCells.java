 ...
 * @date Jan 10, 2013
 */
public class ProfileCells implements ICellInfo {
		
	private Object[] columnCells;
	private IExcelRectangle columnsRect;

	public ProfileCells(Object[] columns, IExcelRectangle rect) {
		this.columnCells = columns;
		this.columnsRect = rect;
	}
